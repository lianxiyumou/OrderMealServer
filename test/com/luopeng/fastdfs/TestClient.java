...
//	  		file_buff = "this is a test".getBytes(ClientGlobal.g_charset);
	        if(file_buff ==  null){
	        	System.out.println("file_buff is null");
	        	return;
	        }
			...
			startTime = System.currentTimeMillis();
	  		results = client.upload_file(file_buff, "png", meta_list);
	  		...
	  		*/
	  		...
	  		else
	  		{
	  			...
	  			startTime = System.currentTimeMillis();
	  			System.out.println("donwload_file group_name:"+group_name+", remote_filename:"+remote_filename);
...
//	  				System.out.println((new String(file_buff)));
	  				File downFile = new File("E:\\my.png");
	  				downFile.createNewFile();
	  				FileOutputStream fos = new FileOutputStream(downFile);
	  				fos.write(file_buff);
	  				System.out.println("write success downFile size:"+downFile.getFreeSpace());
	  			}
